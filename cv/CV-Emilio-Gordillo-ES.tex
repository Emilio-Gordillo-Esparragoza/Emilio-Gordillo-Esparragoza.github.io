...
\textbf{Datos y An\'alisis:} PostgreSQL, Pandas, NumPy, Apache Spark, scikit-learn, Streamlit, an\'alisis estad\'istico (ANOVA, pruebas t)\\
\textbf{Nube y Backend:} AWS (Lambda, SQS, EventBridge, serverless), APIs REST, Supabase, FastAPI, Flask, React\\
...
\begin{itemize}
    \item API estilo scikit-learn (fit/predict/save/load) para imputaci\'on NAIM en datasets tabulares.
\end{itemize}
...
\begin{itemize}
    \item Pipeline multiagente auto-correctivo (LangChain/Ollama) con UI React + Tauri.
\end{itemize}
